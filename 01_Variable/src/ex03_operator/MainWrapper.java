...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    double result = (double)i / j; // 5.0 / 2 -> 5.0 / 2.0 한개만 바꾸면 나머지도 알아서 바뀜
  ...
  public static void ex04() {
    ...
    boolean orResult  = (x == 10) || (y == 10); // 하나의 조건이 만족하기 때문에 true
    boolean notResult = !(x == 10);             // x 1 = 10와 동일한 조건 
  ...
  public static void ex06() {
    ...
    String str1 = "구디" + "아카데미";
    String str2 = 4 + "달라";
    String str3 = 1 + 2 + "번지"; // 3번지 o 12번지 x
